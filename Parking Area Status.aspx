<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parking Area Status.aspx.cs" Inherits="FinalProject.Parking_Area_Status" %>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="Parking Area Status.aspx">Parking Status <span class="sr-only">(current)</span></a>
              </li>
                <li class="nav-item">
        ...
        <div class="carousel-wrap ">
          <div class="owl-carousel client_owl-carousel">
            <div class="item">
              <div class="box">
                <div class="box">
                    <asp:GridView ID="GridView1" Cssclass="table table-bordered table-condensed  table-hover" runat="server"></asp:GridView>
                </div>
                <div class="client_id">
                  <div class="img-box">
                    <img src="images/w1.png" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Higway Parking1
            ...
            <div class="item">
              <div class="box">
                  <div class="box">
                  <asp:GridView ID="GridView2" Cssclass="table table-bordered table-condensed  table-hover" runat="server"></asp:GridView>
                      </div>
                <div class="client_id">
                  <div class="img-box">
                    <img src="images/w1.png" alt="" class="img-1">
              ...
              <div class="box">
                  <div class="box">
                  <asp:GridView ID="GridView3" Cssclass="table table-bordered table-condensed  table-hover" runat="server"></asp:GridView>
                      </div>
                <div class="client_id">
                  <div class="img-box">
                    <img src="images/w1.png" alt="" class="img-1">
